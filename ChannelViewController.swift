...
protocol LeaveChannel {
    func deleteRow(myData dataobject: AnyObject)
}
class ChannelViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, Announcements, ChannelSettings
{
    func callSegueFromCell(myData dataobject: AnyObject) {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        if indexPath.row % 2 == 0
        {
            ...
            */
            ...
            {
                cell.backgroundColor = UIColor(red: 105/255, green: 201/255, blue: 255/255, alpha: 1.0)
            }
